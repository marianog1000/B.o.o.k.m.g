...
function mytheme_scripts() {
	...
	wp_enqueue_style( 'wfmi', get_template_directory_uri().'/webfont-medical-icons-master/wfmi-style.css' );
...
//    wp_enqueue_script( 'index', get_template_directory_uri() . '/js/index.js', array(), '1.0.0', true );
	...
	wp_enqueue_script( 'cbpAnimatedHeader', get_template_directory_uri() . '/js/cbpAnimatedHeader.js',array(), '4.8.2', true);
	wp_enqueue_script( 'classie', get_template_directory_uri() . '/js/classie.js',array(), '4.8.2', true);

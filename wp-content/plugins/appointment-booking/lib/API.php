...
abstract class API
{
    ...
    {
        $url = add_query_arg( array( 'purchase_code' => $purchase_code, 'site_url' => get_site_url( $blog_id ), ), self::API_URL . '/1.0/plugins/' . $plugin_class::getSlug() . '/purchase-code' );
    ...
    public static function sendStats()
    {
        ...
        // Send request.
        wp_remote_post( self::API_URL . '/1.2/stats', array(
            'timeout' => 25,
            'body'    => array(
                'site_url'           => site_url(),

...
class CartItem
{
    ...
    {
        return get_option( 'bookly_service_extras_multiply_nop', 1 ) ? ( $this->getServicePriceWithoutExtras() + $this->getExtrasAmount() ) * $nop : $this->getServicePriceWithoutExtras() * $nop + $this->getExtrasAmount();
    }

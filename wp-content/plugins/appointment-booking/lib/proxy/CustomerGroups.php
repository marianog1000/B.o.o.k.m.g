 ...
 *
 * @method static void renderCustomerDialogRow() Render 'Customer Group' row in edit customer dialog
 * @see \BooklyCustomerGroups\Lib\ProxyProviders\Local::renderCustomerDialogRow()
 *
 ...
 *
 * @method static array prepareCustomerData( array $data, array $row ) Prepare 'Customer Groups' data in customers table
 * @see \BooklyCustomerGroups\Lib\ProxyProviders\Local::prepareCustomerData()
 *

 ...
 * @method static array  prepareNotificationCodes( array $codes, string $set ) Alter array of codes to be displayed in Bookly Notifications.
 * @method static Lib\NotificationCodes prepareNotificationCodesData( Lib\NotificationCodes $codes, Lib\Entities\Appointment $appointment, Lib\Entities\CustomerAppointment $ca, string $locale ) Prepare codes for replacing in notifications
 ...
 * @method static array  updateStaffService( array $_post ) Update staff service settings in add-ons
 */

...
class Controller extends Lib\Base\Controller
{
    ...
    public function checkout()
    {
        ...
        if ( false === Payment\PayuLatam::processPayment( $transaction_state, $this->getParameter( 'referenceCode' ), $this->getParameter( 'signature' ) ) ) {
            ...
            @wp_redirect( remove_query_arg( Payment\PayuLatam::$remove_parameters, Lib\Utils\Common::getCurrentPageURL() ) );
            exit;
        }
    }
    ...
    {
        $replacement = get_option( 'bookly_pmt_payu_latam' ) ? Payment\PayuLatam::replaceData( $this->getParameter( 'form_id' ) ) : false;

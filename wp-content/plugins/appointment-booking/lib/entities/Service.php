...
class Service extends Lib\Base\Entity
{
    ...
    protected static $schema = array(
        ...
        'package_life_time' => array( 'format' => '%d', 'default' => null ),
        'package_size'      => array( 'format' => '%d', 'default' => null ),
        'sub_services'      => array( 'format' => '%s', 'default' => '[]' ),
        'staff_preference'  => array( 'format' => '%s', 'default' => Service::PREFERRED_MOST_EXPENSIVE ),
     ...
     * @return array
     */
    public function getSubServicesIds()
    {
        $result       = array();
        ...
        foreach ( $sub_services as $sub_service ) {
            $result[] = $sub_service['sub_service_id'];
        }
    ...
    {
        $result = array();
        $sub_service_ids = $this->getSubServicesIds();
        $services = self::query()

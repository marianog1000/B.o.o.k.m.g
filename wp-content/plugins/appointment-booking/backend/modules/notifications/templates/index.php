            ...
            <div class="panel panel-default bookly-main" ng-controller="emailNotifications">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <?php \Bookly\Lib\Utils\Common::optionToggle( 'bookly_email_send_as', __( 'Send emails as', 'bookly' ), __( 'HTML allows formatting, colors, fonts, positioning, etc. With Text you must use Text mode of rich-text editors below. On some servers only text emails are sent successfully.', 'bookly' ),
                                array( array( 'html', __( 'HTML', 'bookly' ) ), array( 'text', __( 'Text', 'bookly' ) ) )
                            ) ?>
                        </div>
                        <div class="col-md-6">
                            <?php \Bookly\Lib\Utils\Common::optionToggle( 'bookly_email_reply_to_customers', __( 'Reply directly to customers', 'bookly' ), __( 'If this option is enabled then the email address of the customer is used as a sender email address for notifications sent to staff members and administrators.', 'bookly' ) ) ?>
                        </div>
                    </div>
                    <?php if ( $form->types['combined'] || \Bookly\Lib\Config::recurringAppointmentsActive() ) : ?>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php switch ( $type ) :
                                                ...
                                                case 'client_birthday_greeting': include '_codes_client_birthday_greeting.php'; break;
                                                case 'staff_agenda':             include '_codes_staff_agenda.php';             break;
                                                case 'staff_waiting_list':       include '_codes_staff_waiting_list.php';       break;
                    ...
                    <?php \Bookly\Lib\Proxy\Shared::renderEmailNotifications( $form ) ?>

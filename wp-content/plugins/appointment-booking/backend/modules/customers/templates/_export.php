        ...
        <form action="<?php echo admin_url( 'admin-ajax.php?action=bookly_export_customers' ) ?>" method="POST">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="checkbox"><label><input checked name="exp[full_name]" type="checkbox"> <?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_name' ) ?></label></div>
                        <div class="checkbox"><label><input checked name="exp[first_name]" type="checkbox"> <?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_first_name' ) ?></label></div>
                        <div class="checkbox"><label><input checked name="exp[last_name]" type="checkbox"> <?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_last_name' ) ?></label></div>

...
<div class="bookly-box bookly-js-guest">
    <button class="bookly-btn bookly-inline-block bookly-js-login-show ladda-button"><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_step_details_button_login' ) ?></button>
</div>
<?php endif ?>
...
<div class="bookly-details-step">
    ...
    <div class="bookly-box bookly-table">
        <div class="bookly-form-group">
            <label><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_first_name' ) ?></label>
            <div>
                <input class="bookly-js-first-name" type="text" value="<?php echo esc_attr( $userData->get( 'first_name' ) ) ?>"/>
            </div>
            <div class="bookly-js-first-name-error bookly-label-error"></div>
        </div>
        <div class="bookly-form-group">
            <label><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_last_name' ) ?></label>
            <div>
                <input class="bookly-js-last-name" type="text" value="<?php echo esc_attr( $userData->get( 'last_name' ) ) ?>"/>
            </div>
    ...
    <div class="bookly-box bookly-table">
        ...
        <div class="bookly-form-group">
            ...
            <div>
                <input class="bookly-js-full-name" type="text" value="<?php echo esc_attr( $userData->get( 'full_name' ) ) ?>"/>
            </div>
